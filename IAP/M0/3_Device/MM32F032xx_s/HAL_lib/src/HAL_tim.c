...
/// @retval None.
////////////////////////////////////////////////////////////////////////////////
void TIM_ITConfig(TIM_TypeDef* TIMx, u32 it, FunctionalState state)//TIMIT_TypeDef
{
...
void TIM_SelectOCxM(TIM_TypeDef* TIMx, TIMCHx_Typedef channel, TIMOCMODE_Typedef mode)
{
    ...
    switch (channel) {
        case TIM_Channel_1:
            MODIFY_REG(TIMx->CCMR1, TIM_CCMR1_OC1M, mode);
            break;
        case TIM_Channel_2:
            MODIFY_REG(TIMx->CCMR1, TIM_CCMR1_OC2M, mode << 8);
            break;
        case TIM_Channel_3:
            MODIFY_REG(TIMx->CCMR2, TIM_CCMR2_OC3M, mode);
            break;
        case TIM_Channel_4:
            MODIFY_REG(TIMx->CCMR2, TIM_CCMR2_OC4M, mode << 8);
            break;
        default:
            break;
    }
...
/// @retval None.
////////////////////////////////////////////////////////////////////////////////
void TIM_ClearITPendingBit(TIM_TypeDef* TIMx,  u32 it)//TIMIT_TypeDef
{
