...
void DMA_Init(DMA_Channel_TypeDef* channel, DMA_InitTypeDef* pInitStruct)
{
    MODIFY_REG(
        ...
        ((u32)pInitStruct->DMA_DIR | (u32)pInitStruct->DMA_Mode | (u32)pInitStruct->DMA_PeripheralInc |
         (u32)pInitStruct->DMA_MemoryInc | (u32)pInitStruct->DMA_PeripheralDataSize | (u32)pInitStruct->DMA_MemoryDataSize |
         (u32)pInitStruct->DMA_Priority | (u32)pInitStruct->DMA_M2M));

    MODIFY_REG(channel->CCR, DMA_CCR_ARE, pInitStruct->DMA_Auto_reload);
    channel->CNDTR = pInitStruct->DMA_BufferSize;
    channel->CPAR  = pInitStruct->DMA_PeripheralBaseAddr;
    channel->CMAR  = pInitStruct->DMA_MemoryBaseAddr;
}
...
{
    pInitStruct->DMA_PeripheralBaseAddr = 0;
    pInitStruct->DMA_MemoryBaseAddr     = 0;
    pInitStruct->DMA_DIR                = DMA_DIR_PeripheralSRC;
    pInitStruct->DMA_BufferSize         = 0;
    pInitStruct->DMA_PeripheralInc      = DMA_PeripheralInc_Disable;
    pInitStruct->DMA_MemoryInc          = DMA_MemoryInc_Disable;
    pInitStruct->DMA_PeripheralDataSize = DMA_PeripheralDataSize_Byte;
    pInitStruct->DMA_MemoryDataSize     = DMA_MemoryDataSize_Byte;
    pInitStruct->DMA_Mode               = DMA_Mode_Normal;
    pInitStruct->DMA_Priority           = DMA_Priority_Low;
    pInitStruct->DMA_M2M                = DMA_M2M_Disable;

    pInitStruct->DMA_Auto_reload         = DMA_Auto_Reload_Disable;
}
