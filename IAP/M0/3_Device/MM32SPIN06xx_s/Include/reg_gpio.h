...
#define GPIO_CRL_MODE_MASK              (0x03U)                                 ///< Mode Mask
#define GPIO_CRL_MODE_0                 ((u32)0x00000001)                  ///< Bit 0
#define GPIO_CRL_MODE_1                 ((u32)0x00000002)                  ///< Bit 1
#define GPIO_CRL_MODE_IOMODE0           (0x00U)                                 ///< Mode = 0
#define GPIO_CRL_MODE_IOMODE1           (0x01U)                                 ///< Mode = 1
#define GPIO_CRL_MODE_IOMODE2           (0x02U)                                 ///< Mode = 2
#define GPIO_CRL_MODE_IOMODE3           (0x03U)                                 ///< Mode = 3
#define GPIO_CRL_CNF_MASK               (0x03U)                                 ///< CNF Mask
#define GPIO_CRL_CNF_0                  ((u32)0x00000001)                  ///< Bit 0
#define GPIO_CRL_CNF_1                  ((u32)0x00000002)                  ///< Bit 1
#define GPIO_CRL_CNF_MODE0              (0x00U)                                 ///< Mode = 0
#define GPIO_CRL_CNF_MODE1              (0x01U)                                 ///< Mode = 1
#define GPIO_CRL_CNF_MODE2              (0x02U)                                 ///< Mode = 2
#define GPIO_CRL_CNF_MODE3              (0x03U)                                 ///< Mode = 3


#define GPIO_CRH_MODE_MASK              (0x03U)                                 ///< Mode Mask
#define GPIO_CRH_MODE_0                 ((u32)0x00000001)                  ///< Bit 0
#define GPIO_CRH_MODE_1                 ((u32)0x00000002)                  ///< Bit 1
#define GPIO_CRH_MODE_IOMODE0           (0x00U)                                 ///< Mode = 0
#define GPIO_CRH_MODE_IOMODE1           (0x01U)                                 ///< Mode = 1
#define GPIO_CRH_MODE_IOMODE2           (0x02U)                                 ///< Mode = 2
#define GPIO_CRH_MODE_IOMODE3           (0x03U)                                 ///< Mode = 3
#define GPIO_CRH_CNF_MASK               (0x03U)                                 ///< CNF Mask
#define GPIO_CRH_CNF_0                  ((u32)0x00000001)                  ///< Bit 0
#define GPIO_CRH_CNF_1                  ((u32)0x00000002)                  ///< Bit 1
#define GPIO_CRH_CNF_MODE0              (0x00U)                                 ///< Mode = 0
#define GPIO_CRH_CNF_MODE1              (0x01U)                                 ///< Mode = 1
#define GPIO_CRH_CNF_MODE2              (0x02U)                                 ///< Mode = 2
#define GPIO_CRH_CNF_MODE3              (0x03U)                                 ///< Mode = 3
