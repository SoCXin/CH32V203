...
//#define SYSCLK_HSI_92_160MHz	92160000
...
#elif SYSCLK_HSI_92_160MHz
uint32_t SystemCoreClock         = SYSCLK_HSI_92_160MHz     /*!< System Clock Frequency (Core Clock) */
...
#elif defined SYSCLK_HSI_92_160MHz
static void SetSysClockTo92_160(void);
...
#elif defined SYSCLK_FREQ_92_160MHz
/**
* @brief  Sets System clock frequency to 72MHz and configure HCLK, PCLK2 
*          and PCLK1 prescalers. 
* @note   This function should be used only after reset.
...
static void SetSysClockTo92_160(void)
{
    ...
    if (HSEStatus == (uint32_t)0x01)
    {
        ...
        /*  PLL configuration:  = (HSE ) * (4+1) = 92.16 MHz */
        RCC->CFGR &= (uint32_t)0xFFFCFFFF;
        RCC->CR &= (uint32_t)0x000FFFFF;  
