...
void TIM_TimeBaseInit(TIM_TypeDef* tim, TIM_TimeBaseInitTypeDef* init_struct)
{
    ...
    if ((tim == TIM1) || (tim == TIM16) || (tim == TIM17))
        SET_BIT(tim->RCR, init_struct->TIM_RepetitionCounter);

    SET_BIT(tim->ARR, init_struct->TIM_Period);
    SET_BIT(tim->PSC, init_struct->TIM_Prescaler);
    SET_BIT(tim->EGR, TIM_PSCReloadMode_Immediate);
}
...
void TIM_OC1Init(TIM_TypeDef* tim, TIM_OCInitTypeDef* init_struct)
{
    ...
    MODIFY_REG(tim->CCER, TIM_CCER_CC1P, init_struct->TIM_OCPolarity);
    MODIFY_REG(tim->CCER, TIM_CCER_CC1E, init_struct->TIM_OutputState);
    SET_BIT(tim->CCR1, init_struct->TIM_Pulse);

    if ((tim == TIM1) || (tim == TIM16) || (tim == TIM17)) {
        MODIFY_REG(tim->CCER, TIM_CCER_CC1NP, init_struct->TIM_OCNPolarity);
        MODIFY_REG(tim->CCER, TIM_CCER_CC1NE, init_struct->TIM_OutputNState);
        MODIFY_REG(tim->CR2, TIM_CR2_OIS1, init_struct->TIM_OCIdleState);
        MODIFY_REG(tim->CR2, TIM_CR2_OIS1N, init_struct->TIM_OCNIdleState);
    }
}
...
void TIM_OC2Init(TIM_TypeDef* tim, TIM_OCInitTypeDef* init_struct)
{
    ...
    SET_BIT(tim->CCR2, init_struct->TIM_Pulse);
...
void TIM_OC3Init(TIM_TypeDef* tim, TIM_OCInitTypeDef* init_struct)
{
    ...
    SET_BIT(tim->CCR3, init_struct->TIM_Pulse);
...
void TIM_OC4Init(TIM_TypeDef* tim, TIM_OCInitTypeDef* init_struct)
{
    ...
    SET_BIT(tim->CCR4, init_struct->TIM_Pulse);
...
{
    (state) ? SET_BIT(tim->BDTR, TIM_BDTR_MOE) : CLEAR_BIT(tim->BDTR, TIM_BDTR_MOE);
}
...
{
    SET_BIT(tim->DCR, dma_base);
    SET_BIT(tim->DCR, length);
}
////////////////////////////////////////////////////////////////////////////////
...
{
    (state) ? SET_BIT(tim->CR1, TIM_CR1_ARPE) : CLEAR_BIT(tim->CR1, TIM_CR1_ARPE);
}
...
{
    MODIFY_REG(tim->CCER, TIM_CCER_CC1E << channel, ccx_en << channel);
}
...
void TIM_CCxNCmd(TIM_TypeDef* tim, TIMCHx_Typedef channel, TIMCCxNE_Typedef ccxn_en)
{
    if (channel != TIM_Channel_4)
        MODIFY_REG(tim->CCER, TIM_CCER_CC1NE << channel, ccxn_en << channel);
}
...
static void TI1_Configure(TIM_TypeDef* tim, u16 polarity, u16 selection, u16 filter)
{
    ...
    MODIFY_REG(tim->CCER, TIM_CCER_CC1E | TIM_CCER_CC1P, polarity | TIM_CCER_CC1E);
}
...
static void TI2_Configure(TIM_TypeDef* tim, u16 polarity, u16 selection, u16 filter)
{
    ...
    MODIFY_REG(tim->CCER, TIM_CCER_CC2E | TIM_CCER_CC2P, (polarity << 4) | TIM_CCER_CC2E);
}
...
static void TI3_Configure(TIM_TypeDef* tim, u16 polarity, u16 selection, u16 filter)
{
    ...
    MODIFY_REG(tim->CCER, TIM_CCER_CC3E | TIM_CCER_CC3P, (polarity << 8) | TIM_CCER_CC3E);
}
...
static void TI4_Configure(TIM_TypeDef* tim, u16 polarity, u16 selection, u16 filter)
{
    ...
    MODIFY_REG(tim->CCER, TIM_CCER_CC4E | TIM_CCER_CC4P, (polarity << 12) | TIM_CCER_CC4E);
}
////////////////////////////////////////////////////////////////////////////////
